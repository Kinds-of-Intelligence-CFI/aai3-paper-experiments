  ...
  --timesteps 10000 \
  --aai_timescale 300 \
  --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_10_5M/training-5000000.0 

#   xvfb-run -a python train_from_sh.py \
#   --task ./aai/configs/paper/curriculumL1_2.yaml \
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_2/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_3/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_4/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_5/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_6/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_7/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_8/training-2000000.0 \
...
#   --env ./aai/env/env3.1.3/AAI.x86_64 \
#   --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_9/training-2000000.0 \
...
#  --task ./aai/configs/paper/curriculumL1_10.yaml \
#  --env ./aai/env/env3.1.3/AAI.x86_64 \
#  --from-checkpoint ./logdir/competition-curriculum/competition-curriculum-timescale300-L1_10/training-2000000.0 \
